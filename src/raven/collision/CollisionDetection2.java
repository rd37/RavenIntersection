...
public class CollisionDetection2 {
	...
	public SweepLine2 slQ = new SweepLine2();
	...
	public void solve(){
		...
		while(epQ.queuecount>0){
			...
			if( !(ep instanceof raven.collision.CollisionPoint) ){
				System.out.println("Popped EP belonging to segment "+ep.seg.name+" at Y:"+ep.y+","+ep.x);
			}else{
				System.out.println("Popped EP Collision belongs to segments "+((CollisionPoint)ep).seg1.name+" and "+((CollisionPoint)ep).seg2.name+" at Y:"+ep.y+","+ep.x);
			}
	...
	public void print(String msg){
		System.out.println("CollisionDetection2:"+msg);
	}
}
